...
<body class="bg-gray-50 text-gray-800 p-8">
    ...
    <div class="max-w-4xl mx-auto bg-white p-10 rounded-xl shadow-sm border border-gray-100 print:shadow-none print:border-none">
        ...
        <div class="flex justify-between items-start border-b border-gray-100 pb-8 mb-8">
            <div class="flex items-center">
               ...
               <div>
                   <h1 class="text-2xl font-bold text-emerald-900">Al-Maheen Travel</h1>
        ...
        <!-- Footer Signatures -->
        <div class="flex justify-between mt-20 pt-10 px-10">
