    ...
    <div class="flex justify-center">
        <div class="w-full max-w-2xl">
            ...
            <div class="mb-8 text-center">
                <h2 class="text-3xl font-extrabold text-emerald-900 tracking-tight">Edit Expense</h2>
                <p class="text-emerald-600 mt-2 font-medium">Update operational cost details.</p>
            </div>
            ...
            <div class="bg-white p-8 md:p-10 rounded-[2.5rem] shadow-[8px_8px_16px_rgba(167,243,208,0.4),-8px_-8px_16px_rgba(255,255,255,0.8)] border border-emerald-50 relative overflow-hidden">
                ...
                <form method="POST" action="{{ route('operational-costs.update', $operational->id) }}" enctype="multipart/form-data" class="space-y-6 relative z-10">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <div class="relative">
                                <input type="date" name="expense_date" required value="{{ old('expense_date', $operational->expense_date->format('Y-m-d')) }}"
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="number" name="amount" required min="0" step="1000" value="{{ old('amount', $operational->amount) }}" placeholder="0"
                    ...
                    <div>
                        ...
                        <input type="text" name="title" required value="{{ old('title', $operational->title) }}" placeholder="e.g., Monthly Office Rent"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <select name="category" required
                                ...
                                <option value="Marketing" {{ old('category', $operational->category) == 'Marketing' ? 'selected' : '' }}>Marketing & Ads</option>
                                <option value="Salary" {{ old('category', $operational->category) == 'Salary' ? 'selected' : '' }}>Staff Salary</option>
                                <option value="Utilities" {{ old('category', $operational->category) == 'Utilities' ? 'selected' : '' }}>Utilities (Electricity, Internet)</option>
                                <option value="Office" {{ old('category', $operational->category) == 'Office' ? 'selected' : '' }}>Office Supplies & Rent</option>
                                <option value="Others" {{ old('category', $operational->category) == 'Others' ? 'selected' : '' }}>Others</option>
                            </select>
                    ...
                    <div>
                        ...
                        @if($operational->receipt_path)
                            <div class="mb-2 flex items-center gap-2 text-sm text-emerald-600 bg-emerald-50 p-2 rounded-lg w-fit">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                                </svg>
                                <span>Current Receipt Exists</span>
                            </div>
                        @endif
                    ...
                    <div>
                        ...
                        <textarea name="description" rows="3" placeholder="Additional details..."
                            class="w-full px-6 py-4 rounded-2xl bg-gray-50 border-none shadow-[inset_2px_2px_4px_rgba(0,0,0,0.05),inset_-2px_-2px_4px_rgba(255,255,255,1)] focus:ring-2 focus:ring-emerald-500 focus:outline-none transition-all text-gray-700 placeholder-gray-300 resize-none">{{ old('description', $operational->description) }}</textarea>
                    </div>
